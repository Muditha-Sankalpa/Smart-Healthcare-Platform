...
const PatientDashboard = () => {
  ...
  useEffect(() => {
    ...
    // ── Telemedicine sessions (FIX: runs independently, not nested inside
    //    getProfile().then() so a profile error no longer silences this call) ──
  ...
  const UploadWidget = () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ width: 38, height: 38, borderRadius: '50%', border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path d="M7 18a4 4 0 0 1 0-8 5.5 5.5 0 0 1 10.7 1.6A3.5 3.5 0 0 1 18.5 18H7Z" stroke="#111827" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: '#6b7280' }}>Upload your medical reports from here</div>
        </div>
      </div>
      ...
      <div style={{ border: '1.5px dashed #d1d5db', borderRadius: 12, padding: '24px 14px', textAlign: 'center', background: '#fafafa' }}>
        ...
        <div style={{ fontSize: 12, color: '#9ca3af', marginTop: 3 }}>JPEG, PNG and PDF formats, up to 50 MB.</div>
        ...
        <div style={{ flex: 1, height: '100vh', boxSizing: 'border-box', padding: 28, overflow: 'hidden', position: 'relative' }}>
          ...
          {confirmDeleteReportId && (
            <div
              role="dialog"
              aria-modal="true"
              style={{ position: 'fixed', inset: 0, background: 'rgba(17,24,39,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 50, padding: 16 }}
              onClick={cancelDeleteReport}
            >
              <div
                style={{ width: '100%', maxWidth: 520, background: '#fff', border: '1px solid rgba(17,24,39,0.08)', borderRadius: 16, boxShadow: '0 18px 50px rgba(17,24,39,0.18)', padding: 16 }}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16, minHeight: 0, height: '100%', overflow: 'hidden' }}>
                ...
                <div ref={medicalHistoryRef} style={{ minHeight: 0, flex: 1, display: 'flex' }}>
                  <Card className="rounded-2xl" style={{ display: 'flex', flexDirection: 'column', minHeight: 0, flex: 1, overflow: 'hidden' }}>
                    ...
                    {/* Scrollable list - FIX: removed border padding that was hiding the scrollbar */}
                    <div
                      className="history-scroll"
                      style={{ display: 'flex', flexDirection: 'column', gap: 8, overflowY: 'auto', minHeight: 0, flex: 1, paddingRight: 8 }}
                    >
                            ...
                            {activeTab === 'reports' && (
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                  ...
                                  <button type="button" onClick={() => handleDeleteReport(item._id)} style={{ background: 'transparent', border: 'none', padding: 0, cursor: 'pointer', color: '#9ca3af' }}>
          ...
          {activeNav === 'history' && (
            <div style={{ height: '100%', minHeight: 0 }}>
              <Card className="rounded-2xl" style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0, overflow: 'hidden' }}>
                ...
                <div className="history-scroll" style={{ display: 'flex', flexDirection: 'column', gap: 10, minHeight: 0, flex: 1, overflowY: 'auto', paddingRight: 8 }}>
                  {filterItems(history[activeTab] || []).length === 0 ? (
                  ...
                  {upcomingAppointments.length > 0 ? (
                    <div style={{ border: '0.5px solid #b5d4f4', borderRadius: 10, padding: '14px 16px', background: '#e8f0fe' }}>
                      ...
                      <div style={{ fontSize: 12, color: '#185fa5', marginTop: 3 }}>
                        ...
                        <a href="/patient/appointments" style={{ color: '#185fa5', fontWeight: 500, textDecoration: 'underline' }}>View</a>
                      </div>
                    </div>
                  ) : (
